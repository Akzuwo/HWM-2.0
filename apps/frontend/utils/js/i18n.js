    ...
    de: {
      common: {
        ...
        nav: {
          ...
          upcoming: 'Anstehend',
          upcomingHint: 'Termine und Abgaben im Blick behalten',
          dayPreview: 'Tagesvorschau',
          dayPreviewHint: 'Unterricht und Räume des Tages',
          weekPreview: 'Wochenvorschau',
          weekPreviewHint: 'Der Stundenplan der ganzen Woche',
          dayBrief: 'Daybrief',
          dayBriefHint: 'Kompakte Zusammenfassung deiner nächsten Tage',
          now: 'Jetzt',
          schoolTime: 'Während der Schule',
          departures: 'Abfahrten',
          departuresHint: 'Die nächsten Verbindungen',
          todos: 'ToDos',
          todosHint: 'Persönliche Aufgaben organisieren',
          weeklyPreview: 'Wochenvorschau',
          grades: 'Notenrechner',
          gradesHint: 'Noten und Ziele berechnen',
          currentSubject: 'Aktuelles Fach',
          currentSubjectHint: 'Was jetzt läuft und was danach kommt',
          other: 'Sonstiges',
          logout: 'Abmelden',
      ...
      calendar: {
        ...
        filters: {
          ...
          subjectHint: 'Blende Fächer aus, die für dich nicht relevant sind.',
          showCompletedTodos: 'Beendete ToDos anzeigen',
          saveError: 'Filter konnten nicht gespeichert werden.',
        },
        todoStatus: {
          label: 'ToDo-Status',
          open: 'Offen',
        ...
        dragConfirm: {
          ...
          message: 'Möchtest du diesen Eintrag auf das gewählte Datum verschieben?',
          messageWithDate: 'Möchtest du "{title}" auf den {date} verschieben?',
          confirm: 'Verschieben',
          success: 'Eintrag wurde verschoben.',
          error: 'Eintrag konnte nicht verschoben werden.',
          entryFallback: 'dieser Eintrag',
        },
        actions: {
          create: {
            label: 'Neuer Eintrag',
        ...
        modal: {
          ...
          messages: {
            ...
            statusSaveSuccess: 'Status wurde gespeichert.',
    ...
    en: {
      common: {
        ...
        nav: {
          ...
          upcoming: 'Upcoming',
          upcomingHint: 'Keep track of dates and assignments',
          dayPreview: 'Day preview',
          dayPreviewHint: 'Today’s lessons and rooms',
          weekPreview: 'Week preview',
          weekPreviewHint: 'Your timetable for the whole week',
          dayBrief: 'Daybrief',
          dayBriefHint: 'A compact summary of the days ahead',
          now: 'Now',
          schoolTime: 'During school',
          departures: 'Departures',
          departuresHint: 'The next connections',
          todos: 'ToDos',
          todosHint: 'Organize personal tasks',
          weeklyPreview: 'Weekly Preview',
          grades: 'Grade Calculator',
          gradesHint: 'Calculate grades and targets',
          currentSubject: 'Current Subject',
          currentSubjectHint: 'What is happening now and next',
          other: 'Other',
          logout: 'Log out',
    ...
    it: {
      common: {
        ...
        nav: {
          ...
          upcomingHint: 'Tieni sotto controllo scadenze e compiti',
          dayPreview: 'Anteprima giornaliera',
          dayPreviewHint: 'Le lezioni e le aule di oggi',
          weekPreview: 'Vista settimanale',
          weekPreviewHint: 'Il tuo orario per tutta la settimana',
          dayBrief: 'Daybrief',
          dayBriefHint: 'Un riepilogo compatto dei prossimi giorni',
          now: 'Adesso',
          schoolTime: 'Durante la scuola',
          departures: 'Partenze',
          departuresHint: 'I prossimi collegamenti',
          todos: 'ToDo',
          todosHint: 'Organizza le attività personali',
          weeklyPreview: 'Anteprima settimanale',
          grades: 'Calcolatore di voti',
          gradesHint: 'Calcola voti e obiettivi',
          currentSubject: 'Materia attuale',
          currentSubjectHint: 'Cosa c’è ora e cosa viene dopo',
          other: 'Altro',
      ...
      dayOverview: {
        pageTitle: 'Anteprima giornaliera',
    ...
    fr: {
      common: {
        ...
        nav: {
          ...
          upcoming: 'À venir',
          upcomingHint: 'Suivre les échéances et les devoirs',
          dayPreview: 'Aperçu du jour',
          dayPreviewHint: 'Les cours et salles du jour',
          weekPreview: 'Aperçu de la semaine',
          weekPreviewHint: 'Votre horaire de toute la semaine',
          dayBrief: 'Daybrief',
          dayBriefHint: 'Un résumé compact des prochains jours',
          now: 'Maintenant',
          schoolTime: 'Pendant les cours',
          departures: 'Départs',
          departuresHint: 'Les prochaines correspondances',
          todos: 'ToDos',
          todosHint: 'Organiser les tâches personnelles',
          weeklyPreview: 'Aperçu hebdomadaire',
          grades: 'Calculateur de notes',
          gradesHint: 'Calculer les notes et les objectifs',
          currentSubject: 'Matière actuelle',
          currentSubjectHint: 'Ce qui a lieu maintenant et ensuite',
          other: 'Autres',
          logout: 'Déconnexion',
