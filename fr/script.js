...
const LOGIN_TEXT = {
    ...
    verificationTitle: 'Vérification de l’e-mail requise',
    verificationDescription: 'Nous t’avons envoyé un lien de vérification. L’envoi de l’e-mail peut prendre quelques minutes. Tu peux demander ici un nouveau message.',
    verificationResend: 'Renvoyer l’e-mail de vérification',
    verificationResendLoading: 'Envoi…',
    verificationPending: 'Nous vérifions ton lien de confirmation…',
    verificationSuccess: 'Parfait ! Ton adresse e-mail a été confirmée. Tu peux te connecter.',
    verificationAlready: 'Ton adresse e-mail est déjà confirmée. Tu peux te connecter.',
    verificationExpired: 'Le lien de confirmation a expiré. Demande un nouvel e-mail.',
    verificationInvalid: 'Ce lien de confirmation est invalide. Demande un nouvel e-mail.',
    verificationGenericError: 'La confirmation a échoué. Réessaie plus tard, s’il te plaît.',
    resendSuccess: 'Si un compte existe, nous avons renvoyé l’e-mail. L’envoi peut prendre quelques minutes.',
    ...
    registerSuccess: 'Presque terminé ! Nous t’avons envoyé un e-mail de confirmation. L’envoi peut prendre quelques minutes.',
...
async function resendVerification(form) {
    ...
    try {
        ...
        console.error('Renvoi impossible', error);
        setLoginFeedback(LOGIN_TEXT.resendError, 'error', targetForm);
    } finally {
        if (button) {
...
async function handleVerificationToken(isLoginPage) {
    ...
    try {
        ...
        console.error('La vérification de l’e-mail a échoué', error);
        setLoginFeedback(LOGIN_TEXT.verificationGenericError, 'error');
    }
}
