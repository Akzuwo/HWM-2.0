...
const LOGIN_TEXT = {
    ...
    verificationDescription: 'Nous t’avons envoyé un lien de vérification. Tu peux demander ici un nouveau message.',
    verificationResend: 'Renvoyer l’e-mail de vérification',
    verificationResendLoading: 'Envoi…',
    resendSuccess: 'Si un compte existe, nous avons renvoyé l’e-mail.',
