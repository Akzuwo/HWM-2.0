...
const LOGIN_TEXT = {
    ...
    verificationDescription: 'We sent you a verification link. You can request a new message here.',
    verificationResend: 'Resend verification email',
    verificationResendLoading: 'Sending…',
    resendSuccess: 'If an account exists, we have sent the email again.',
    ...
    registerSuccess: 'Almost done! We have sent you a confirmation email.',
