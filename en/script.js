...
const CALENDAR_MODAL_MESSAGES = {
    ...
    saveError: CALENDAR_MODAL_SCOPE('messages.saveError', 'Unable to save the entry.'),
    ...
    deleteSuccess: CALENDAR_MODAL_SCOPE('messages.deleteSuccess', 'Entry deleted successfully.')
};
