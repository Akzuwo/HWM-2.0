...
const LOGIN_TEXT = {
    ...
    verificationDescription: 'We sent you a verification link. Email delivery can take a few minutes. You can request a new message here.',
    verificationResend: 'Resend verification email',
    verificationResendLoading: 'Sending…',
    verificationPending: 'We are checking your verification link…',
    verificationSuccess: 'Success! Your email address has been confirmed. You can sign in now.',
    verificationAlready: 'Your email address is already confirmed. You can sign in.',
    verificationExpired: 'The confirmation link has expired. Please request a new email.',
    verificationInvalid: 'This confirmation link is invalid. Please request a new email.',
    verificationGenericError: 'We could not confirm your email. Please try again later.',
    resendSuccess: 'If an account exists, we have sent the email again. Delivery can take a few minutes.',
    ...
    passwordResetSent: 'If an account exists, we have emailed a reset link.',
    ...
    adminNavButton: '🛠️ Admin',
    authStatusGuest: 'Not signed in',
    authStatusSignedIn: (roleLabel) => `Signed in as ${roleLabel}`,
    roleLabels: {
        admin: 'Administrator',
        teacher: 'Teacher',
    ...
    registerEmailInvalid: 'Please enter a valid school email address.',
    ...
    registerClassPlaceholder: 'e.g. 3a',
    ...
    registerSuccess: 'Almost done! We have sent you a confirmation email. Delivery can take a few minutes.',
