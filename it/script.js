...
const LOGIN_TEXT = {
    ...
    authStatusSignedIn: (roleLabel) => `Connesso come ${roleLabel}`,
    roleLabels: {
...
function syncAccountControls() {
    ...
    const profileLabel = LOGIN_TEXT.accountProfile || 'Profilo';
    const logoutLabel = LOGIN_TEXT.logoutButton || 'Esci';
...
function updateAuthButton() {
    ...
    const authenticated = isAuthenticated();
    const loginLabel = LOGIN_TEXT.loginButton || 'Accedi';
        ...
        <div class="login-container" role="dialog" aria-modal="true" aria-labelledby="auth-overlay-title">
            ...
            <header class="login-header">
                ...
                <div class="login-heading">
                    ...
                    <span class="login-badge" data-auth-register-only data-auth-display="inline-flex" aria-hidden="true" hidden>${LOGIN_TEXT.newBadge || 'NUOVO'}</span>
                </div>
...
const CALENDAR_MODAL_BUTTONS = {
    add: CALENDAR_MODAL_SCOPE('buttons.add', 'Aggiungi voce'),
...
const CALENDAR_MODAL_MESSAGES = {
    ...
    saveRetry: CALENDAR_MODAL_SCOPE(
        'messages.saveRetry',
        'Non siamo riusciti a salvare la voce dopo vari tentativi. Riprova più tardi.'
    )
};
...
async function refreshCalendarEntries() {
    try {
        ...
        console.error('Impossibile aggiornare il calendario dopo il salvataggio:', error);
    }
