...
const LOGIN_TEXT = {
    ...
    verificationDescription: 'Ti abbiamo inviato un link di verifica. Puoi richiedere qui un nuovo messaggio.',
    verificationResend: "Invia di nuovo l'email di verifica",
    verificationResendLoading: 'Invio…',
    resendSuccess: "Se esiste un account, abbiamo inviato nuovamente l'email.",
    ...
    registerSuccess: 'Quasi fatto! Ti abbiamo inviato un’e-mail di conferma.',
